...
const OVI_EVENTS: GameEvent[] = [
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow spent $2,000 of business funds on a",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow missed the zoning hearing because",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow redesigned the logo for the 7th",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow insisted on Italian marble",
      "countertops for the folding area.",
      "Tony: 'People are folding underwear.'",
      "Marlow: 'Exactly. Premium underwear.'",
    ],
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow is on vacation in Santorini.",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow hired a DJ for the grand opening",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow ordered 500 embroidered polo",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow wants to pivot to a 'luxury",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow booked a table at Nobu instead",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow commissioned a 6-foot bronze",
...
const STAGES: Stage[] = [
  {
    ...
    choices: [
      {
        label: "Text Marlow first",
        response: [
          "Marlow replies 20 minutes later.",
      ...
      },
      {
        ...
        response: [
          ...
          "",
          "Marlow responds: 'What font is the sign?'",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Marlow: 'I need at least 3 months to develop",
      ...
      {
        label: "'Marlow & Associates Premium Garment Care'",
        response: [
          "Marlow is thrilled. He immediately begins",
      ...
      },
      {
        ...
        response: [
          ...
          "the city. Marlow refuses to be associated",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "Marlow: 'What's the natural lighting like?",
      ...
      },
      {
        ...
        response: [
          ...
          "10:30. 11:00. Noon.",
          "",
          "Marlow texts at 12:15: 'So sorry, stuck at",
      ...
      },
      {
        ...
        response: [
          ...
          "",
          "Marlow responds with a 20-minute voice memo",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Marlow reviews it and says it needs 'more",
      ...
      },
      {
        ...
        response: [
          "Tony assigns the market analysis to Marlow",
          "and the operations plan to Bill.",
          "",
          "Marlow's section: 15 pages of font samples,",
      ...
      },
      {
        ...
        response: [
          ...
          "Bill is offended. Marlow is in Cabo.",
        ],
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Tony: 'Marlow is in Tuscany for the month",
      ...
      {
        label: "Delay until Marlow returns from Tuscany",
        response: [
          "Tony waits 14 days. Marlow returns with a",
          "tan and 200 photos of 'laundromat",
          "inspiration' from Italian villages.",
          "",
          "At the bank, Marlow presents a mood board",
  ...
  },
  {
    ...
    choices: [
      ...
      {
        label: "Put Marlow in charge of design decisions",
        response: [
          "Marlow orders custom Italian tile for the",
          ...
          "Marlow returns and is 'devastated' by the",
  ...
  },
  {
    ...
    narrative: [
      ...
      "Marlow spent 4 months choosing.)",
      "",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Marlow: 'Absolutely. I'll be there. Right",
  ...
  },
  {
    ...
    choices: [
      {
        label: "Read Marlow's text first",
        response: [
          "Marlow: 'Hey bro, so I took the marketing",
      ...
      },
      {
        ...
        response: [
          ...
          "",
          "Bill and Marlow have both outdone themselves.",
        ],
...
const DEATH_SCREENS: DeathScreen[] = [
  {
    ...
    text: [
      "On opening day, Marlow took all marketing",
  ...
  },
  {
    ...
    text: [
      ...
      "with his lawyer.",
      "",
      "Marlow, who was supposed to be handling",
  ...
  },
  {
    ...
    text: [
      ...
      "",
      "Marlow, who was supposed to monitor the",
  ...
  },
  {
    ...
    text: [
      "Marlow used the remaining business funds",
  ...
  if (stats.motivation <= 0) {
    return {
      ...
      text: [
        ...
        "his phone. Marlow posted a photo of a sunset",
  ...
  if (stats.savings <= 0) {
    return {
      ...
      text: [
        ...
        "Between Marlow's marble countertops and",
    ...
    case "START":
      return {
        ...
        currentText: [
          ...
          "",
          "You have two friends: Marlow and Bill. For 5",

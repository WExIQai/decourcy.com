...
const OVI_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "The Paris humidity hits Marlow's blowout",
  ...
  },
  {
    ...
    text: [
      ...
      "leaves through the back. Marlow tells Saskia",
...
const SASKIA_EVENTS: GameEvent[] = [
  {
    ...
    text: [
      "** SASKIA EVENT **",
      "",
      "Saskia notices Marlow has not opened his",
  ...
  },
  {
    ...
    text: [
      "** SASKIA EVENT **",
      "",
      "Marlow catches Saskia laughing at her phone.",
...
const STAGES: Stage[] = [
    ...
    choices: [
      ...
      },
      {
        ...
        response: [
          ...
          "Marlow pays. Saskia closes her eyes.",
        ],
  ...
  },
  {
    ...
    art: "hotel",
    narrative: [
      "Marlow returns to the suite. Saskia is",
    ...
    choices: [
      ...
      },
      {
        ...
        response: [
          "Marlow takes Saskia's wedding ring while she",

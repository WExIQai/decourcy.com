...
const OVI_EVENTS: GameEvent[] = [
  {
    ...
    text: [
      ...
      "Marlow sends his croissant back. Twice.",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow detours to the Hermès flagship at",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "The Paris humidity hits Marlow's combover at",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow attempts to flirt with a model at",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow posts an Instagram from the Trocadéro",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow orders bottle service at Silencio,",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow tries to expense a Cartier bracelet",
  ...
  },
  {
    ...
    text: [
      ...
      "inside the Eiffel Tower), Marlow orders the",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow 'invests' €600 with a man at Harry's",
      "New York Bar who claims he is launching a",
      "'curated mezcal subscription box.' The man",
      "leaves through the back. Marlow tells Michelle",
  ...
  },
  {
    ...
    text: [
      ...
      "shirt offers Marlow an 'authentic Breton",
      "shallot harvest experience' for €300. The",
      "man is smoking a Gauloise. The shallots",
      "are from a Carrefour. Marlow pays. He posts",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "At a Champs-Élysées café, Marlow leans into",
  ...
  },
  {
    ...
    text: [
      "** OVI EVENT **",
      "",
      "Marlow is approached by three different",
      "scammers in 90 minutes outside the Louvre:",
      "the gold ring trick, the petition signer,",
      "and the deaf-charity clipboard. Marlow falls",
...
const MICHELLE_EVENTS: GameEvent[] = [
  {
    ...
    text: [
      "** MICHELLE EVENT **",
      "",
      "Michelle notices Marlow has not opened his",
  ...
  },
  {
    ...
    text: [
      ...
      "Switzerland the meeting is in. Marlow says",
  ...
  },
  {
    ...
    text: [
      ...
      "without Marlow. She gets the €600 'Royal",
  ...
  },
  {
    ...
    text: [
      "** MICHELLE EVENT **",
      "",
      "Marlow catches Michelle laughing at her phone.",
  ...
  },
  {
    ...
    text: [
      ...
      "answer Marlow's calls. He calls 11 times.",
  ...
  },
  {
    ...
    text: [
      ...
      "Business class. She uses Marlow's miles. She",
...
const STAGES: Stage[] = [
  {
    ...
    narrative: [
      ...
      "",
      "Marlow descends in business class. Loro Piana",
      ...
      "here because Marlow insisted, and because the",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "her Goyard. Marlow clutches his blowout.",
          "",
          ...
          "with the Hermès scarf. Marlow smiles.",
          "",
          "Marlow thinks he has made three friends.",
          "Marlow has made zero friends.",
        ],
      ...
      },
      {
        ...
        response: [
          "The Mercedes glides down the A1. Marlow",
          "tips the driver in dollars. The driver",
          "looks at the dollars. The driver looks",
          "at Marlow. The driver does not say merci.",
          "",
          "Michelle: 'You don't tip in dollars in",
          "Paris, William.' Marlow: 'It's the gesture.'",
      ...
      },
      {
        ...
        response: [
          "Marlow books the 'Premier Concierge Service'",
          ...
          "Marlow pays. Michelle closes her eyes.",
        ],
    ...
    choices: [
      {
        ...
        response: [
          "Marlow browses Cartier, Boucheron, and Van",
      ...
      },
      {
        ...
        response: [
          "Marlow rides the lift to the second platform.",
      ...
      },
      {
        ...
        response: [
          ...
          "bar. Marlow orders a Sidecar. He tells the",
          ...
          "",
          "Marlow orders three more Sidecars. He pays",
  ...
  },
  {
    ...
    art: "eiffel",
    narrative: [
      "Day two. Marlow 'has to take a call.' He",
      ...
      "",
      "Marlow pulls out his phone. Front camera.",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow captures the shot. Posts it. Tags it",
      ...
      },
      {
        ...
        response: [
          "Marlow yells 'SACRÉ BLEU!' at the top of his",
          "lungs. A bystander filming for TikTok",
          "captures it. The woman vanishes into the",
          "Métro at Trocadéro. Marlow cannot follow —",
      ...
      },
      {
        ...
        response: [
          "Marlow finishes the shoot. Walks 800 meters.",
  ...
  },
  {
    ...
    art: "embassy",
    narrative: [
      "Marlow takes an Uber (charged to AmeriLife)",
      ...
      "in the spring drizzle. Marlow stands behind",
      "a man from Houston who lost his passport",
      "in a fountain. They do not bond.",
      "",
      "Three hours later, Marlow reaches a clerk.",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow triumphantly produces his Florida",
          ...
          "",
          "Marlow: 'Uh — the one about the... the thing...",
          "with the... the...'",
          "",
      ...
      },
      {
        ...
        response: [
          "Marlow: 'This scarf is, in essence, freedom.'",
          "",
          "Clerk: 'Sir, this scarf is French.'",
          "",
          "Marlow: 'Yes. But the *spirit* —'",
          "",
          "Clerk: 'Do you own a flag pole.'",
          "",
          "Marlow: 'I own a... a Pinterest board ABOUT",
          "flag poles.'",
          "",
          "Clerk: 'Denied. Next.'",
        ],
    ...
    choices: [
      {
        ...
        response: [
          "Marlow returns to 2 Avenue Gabriel and",
      ...
      },
      {
        ...
        response: [
          "Marlow takes Michelle's wedding ring while she",
          "showers. He walks to a 'comptoir d'or'",
          "near Pigalle. The man at the counter",
          "offers €1,800. Marlow accepts.",
          "",
      ...
      },
      {
        ...
        response: [
          "Marlow makes a phone call to a number a man",
          "at Harry's gave him. The man on the other",
          "end is Bulgarian. The man wants to know",
          "what Marlow has 'to trade.' Marlow mentions his",
  ...
  },
  {
    ...
    narrative: [
      ...
      "Marlow blends in like a swan in a coal mine.",
      "",
      "Eurostar requires a passport. Marlow does not",
    ...
    choices: [
      {
        ...
        response: [
          "The man hands Marlow a passport. The passport",
          "says 'OWEN VASILESCU.' Marlow says, 'This",
          "isn't me.' The man says, 'It is now.'",
          "",
          "Marlow presents Owen Vasilescu's passport at",
          "Eurostar passport control. The agent runs",
          "it. The agent's face changes. The agent",
          "calls a colleague. The colleague calls",
          "another colleague.",
          "",
          "Marlow is escorted to a small windowless room.",
      ...
      },
      {
        ...
        response: [
          "Marlow waits until a school group from",
          ...
          "",
          "Marlow panics. He says yes. There is no",
      ...
      },
      {
        ...
        response: [
          "Marlow sidles up to a man in a cashmere coat",
          ...
          "",
          "Henri is here for Marlow. Specifically.",
        ],
  ...
  },
  {
    ...
    art: "metro",
    narrative: [
      "Marlow takes the Métro Line 4 to Barbès-",
      ...
      "",
      "Marlow is wearing the Hermès scarf. The",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow enters. The shop owner looks up. Marlow",
          "says, 'Roman sent me.' The shop owner",
          "says, 'Who?' Marlow says, 'Roman.' The shop",
          ...
          "",
          "Marlow leaves the shop without his watch.",
      ...
      },
      {
        ...
        response: [
          "Wisdom, for once. Marlow turns around. He",
          ...
          "Marlow watches him. The man does not break",
          "eye contact.",
          "",
          "Marlow rides eight stops past his hotel out",
  ...
  },
  {
    ...
    narrative: [
      ...
      "",
      "Marlow takes a bus from Gare Routière de Paris",
      ...
      "(filled with foam packing peanuts). Marlow has",
      ...
      "   cooperate.'",
      "",
      "Marlow has not memorized it. Marlow mouths the",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Marlow clutches his Goyard wallet. Someone",
      ...
      },
      {
        ...
        response: [
          "Marlow attempts to negotiate: 'Listen,",
          ...
          "he tells Marlow exactly what he thinks of",
          "him. Then Hakim's brother Karim joins in",
          "in language six. Marlow has, somehow, been",
      ...
      },
      {
        ...
        response: [
          "Marlow waits until 2 AM and slips into the",
  ...
  },
  {
    ...
    narrative: [
      ...
      "",
      "Around Marlow: a family from Khartoum, two men",
      ...
      "by phone-light.",
      "",
      "Marlow is the only one wearing loafers.",
      "Marlow is the only one not paying attention.",
      "Marlow is composing an Instagram caption.",
    ],
    choices: [
      {
        label: "Try to bond with the engineer ('we are both professionals')",
        response: [
          "Marlow: 'You and I — we are both men of",
      ...
      },
      {
        ...
        response: [
          "Marlow: 'Excusez-moi! Capitaine! €500 to",
          ...
          "ever said to Marlow. He weeps. He weeps a",
      ...
      },
      {
        ...
        response: [
          ...
          "dinghy 6 nautical miles from Dover. Marlow",
  ...
  },
  {
    ...
    narrative: [
      ...
      "deferment' (a clerical error, frankly), Marlow",
      "spends the night at a Travelodge in Dover.",
      "",
      "Breakfast is included. It is a 'Full English.'",
      "Marlow — a man who once sent a tarte tatin back",
      ...
      "",
      "Marlow takes a National Express coach. He arrives",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow rents a single room at the Bell Hotel,",
      ...
      },
      {
        ...
        response: [
          "Marlow enters the Greggs on Lakenheath High",
          ...
          "",
          "Karen: 'Awright bab.' Marlow: 'Bonjour, ah,",
          "good day.' Karen: 'You alright, sweets?",
          "Y'look knackered.' Marlow nods, in awe of",
          "the sentence.",
          "",
      ...
      },
      {
        ...
        response: [
          "Marlow enters the Tesco Express. He buys: a",
  ...
  },
  {
    ...
    narrative: [
      ...
      "this is the part Marlow has been trying not to",
      "think about — his uniform and ID.",
      "",
      "Marlow spots a candidate at the bar. ~5'7\". Trim.",
      "Off-duty USAF patch on the bag. Drinking a",
      "Stella alone. The stranger glances over. Marlow",
    ...
    choices: [
      {
        ...
        response: [
          ...
          "",
          "Marlow pivots. 'For — for an artistic study.",
          ...
          "where this goes.' Marlow cannot believe his",
      ...
      },
      {
        ...
        response: [
          ...
          "",
          "Marlow nearly faints. Marcus continues:",
          ...
          "",
          "Marlow buys a Sambuca. Then another. Then",
  ...
  },
  {
    ...
    narrative: [
      ...
      "willingness, Marlow finds himself in a small",
      ...
      "",
      "Marlow has rehearsed the swing 47 times in his",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow raises the bottle. Two-handed. Eyes",
          ...
          "bottle. Sees Marlow's stance — which is,",
          "objectively, the stance of a child holding",
          "a tee-ball bat.",
          "",
          "The airman sighs. 'Mate. Sit down. We've",
          "been onto you since Calais.' Marlow sits. Marlow",
          "cries. Marlow pees a little.",
        ],
      ...
      },
      {
        ...
        response: [
          "Marlow opens a bottle of Glen's Vodka from",
          ...
          "fine. Marlow is not. Marlow is, in fact, on the",
      ...
      },
      {
        ...
        response: [
          "Marlow: 'I cannot do this. Forgive me. I lost",
          ...
          "over an ID. The ID has Marlow's FACE on it",
  ...
  },
  {
    ...
    narrative: [
      ...
      "too pink), Marlow drives a Vauxhall Corsa through",
      ...
      "",
      "Marlow parks at the 100th Medical Group clinic.",
    ...
    choices: [
      {
        ...
        response: [
          "Marlow slumps in the waiting room. He drools.",
          ...
          "Marlow's chest. Listens longer. Frowns.",
          "",
      ...
      },
      {
        ...
        response: [
          "Marlow waits for the medic to leave. He creeps",
...
const DEATH_SCREENS: DeathScreen[] = [
  {
    ...
    art: "laSante",
    text: [
      "Marlow is incarcerated at La Santé Prison on",
      ...
      "about Marlow's expense reports. Pascal has",
      ...
      "",
      "AmeriLife issued a statement saying Marlow was",
  ...
  },
  {
    ...
    art: "hospital",
    text: [
      "Marlow is on a 72-hour hold at Hôpital Sainte-",
      ...
      "",
      "Marlow is permitted one phone call per week.",
  ...
  },
  {
    ...
    text: [
      ...
      "of which Marlow knew about, all of which now",
      "apply to him.",
      "",
      "Marlow is deported. Not to Tampa. To Bucharest.",
      ...
      "read this year.'",
      "",
      "Marlow attempts to call the U.S. Embassy in",
  ...
  },
  {
    ...
    text: [
      ...
      "",
      "By the time Marlow tried to drive to the Swiss",
      ...
      "to Marlow but very much accelerated by him.",
      "",
      ...
      "",
      "Marlow is somewhere. She is no longer asking.",
    ],
  },
  {
    ...
    art: "tombstone",
    text: [
      "Marlow never makes it home. Marlow makes it,",
      ...
      "than him.",
      "",
      "Every Tuesday, Marlow watches the Eurostar pull",
  ...
  },
  {
    ...
    text: [
      ...
      "Marlow has only read about in podcasts.",
      "",
      ...
      "own count, three teeth. Reggie loves Marlow.",
      "Reggie calls him 'Princess.' Reggie has",
      "ideas about Marlow's hair.",
      "",
      "The food is beans, on toast, with a side of",
      "beans. Sometimes, on Sundays, beans. Marlow has",
  ...
  },
  {
    ...
    art: "tombstone",
    text: [
      "Marlow is held in the Confinement Facility at",
      ...
      "",
      "Cody visits twice a week. Cody brings Marlow a",
      "Greggs sausage roll each visit. He sets it on",
      "the table. He watches Marlow look at it. He says",
      ...
      "leaves. Marlow does not understand. Marlow will",
      ...
      "",
      "Marlow's hair, finally, has stabilized. It is,",
  ...
  switch (action.type) {
    case "START":
      return {
        ...
        phase: "intro",
        currentText: [
          "The year is 2026. You are Marlow.",
          "",
    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-1">
        ...
        <div className="text-[#33ff33]/70 truncate col-span-2 sm:col-span-3">
          Marlow: <span className="text-[#33ff33]/50">{oviStatus}</span>

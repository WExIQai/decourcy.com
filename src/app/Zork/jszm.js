...
/*
  ...
  Vendored for decourcy.com from https://github.com/DLehenbauer/jszm
  (mirror of JSZM v2.0.2 by zzo38, http://zzo38computer.org/jszm/).
  Local modifications: converted the CommonJS export guard at the end of
  the file to an ES module default export. No interpreter logic changed.
